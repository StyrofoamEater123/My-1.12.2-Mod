...
public class ParaItemsInit { //This is the class for registering items!
    public static final List<Item> ITEMS = new ArrayList<Item>();

    public static final Item COPPER_INGOT = new ItemBase("copper_ingot", ParacraftItemsTab.INSTANCE);
